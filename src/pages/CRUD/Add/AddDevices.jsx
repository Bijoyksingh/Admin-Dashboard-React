...
export default function AddDevices() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const addDeviceData = { dName, partyCode, current, temp, vibration, para1, para2, para3, para4, para5, para6, para7, para8, para9, para10 };
  ...
  return (
    <div className="w-75 m-auto mt-3 border rounded text-bg-light  ">
      <h1 className="mt-3 text-center">Add Device</h1>
      <Box
        component="form"
